...
public class SPUtil {
    ...
    public static boolean putData(String spName, String key, Object value) {
        ...
        Context context = PinziApplication.getInstance();
        ...
        if (value instanceof String) {
            ...
            try {
                ...
                String base64Str = com.jilian.pinzia.utils.Base64.encodeObject(serialObi);//通过Spring 4 android将这个value对象转为字符串
    ...
    public static <T> T getData(String spName, String key, Class<T> type, T defaultVal) {
        ...
        if (String.class.equals(type)) {
            ...
            try {
                ...
                return (T) com.jilian.pinzia.utils.Base64.decodeToObject(objStr);
            } catch (IOException e) {
                e.printStackTrace();
                return null;
