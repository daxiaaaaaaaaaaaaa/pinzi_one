...
public class ToastUitl {
    ...
    private static Toast initToast(CharSequence message, int duration) {
        if (toast == null) {
            toast = Toast.makeText(PinziApplication.getContext(), message, duration);
        } else {
    ...
    public static void showShort(int strResId) {
        initToast(PinziApplication.getContext().getResources().getText(strResId), Toast.LENGTH_SHORT).show();
    }
    ...
    public static void showLong(int strResId) {
        initToast(PinziApplication.getContext().getResources().getText(strResId), Toast.LENGTH_LONG).show();
    }
     ...
     * @return imageToast
     */
    public static Toast showImageToastFail(String tvStr) {
        if (imageToast == null) {
            imageToast = new Toast(PinziApplication.getContext());
        }
        View view = LayoutInflater.from(PinziApplication.getContext()).inflate(R.layout.toast_custom, null);
