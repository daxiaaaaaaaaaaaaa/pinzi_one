...
public class GoodsFragment extends BaseFragment implements CustomItemClickListener, MyGoodsAdapter.DeleteListener {
    ...
    public void getFootPrintAndCollect() {
        viewModel.FootPrintAndCollect(PinziApplication.getInstance().getLoginDto().getId(), "1", classify, pageNo, pageSize);
