...
import com.jilian.pinzi.adapter.MoreNewGoodsAdapter;
 ...
 * 更多新品
 */
public class MoreNewGoodsActivity extends BaseActivity implements CustomItemClickListener,ViewPagerItemClickListener {
    ...
    public int intiLayout() {
        return R.layout.activity_more_newgoods;
    }

    @Override
    public void initView() {
        setNormalTitle("更多新品", v -> finish());
        ...
        setrightImage(R.drawable.image_shop, new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MoreNewGoodsActivity.this, MainActivity.class);
        ...
        adapter = new MoreNewGoodsAdapter(this, datas, this,getClasses());
            ...
            public void onChanged(@Nullable BaseDto<List<StartPageDto>> listBaseDto) {
                ...
                if (EmptyUtils.isNotEmpty(listBaseDto.getData())) {
                    for (int i = 0; i < listBaseDto.getData().size(); i++) {
                        View view = LayoutInflater.from(MoreNewGoodsActivity.this).inflate(R.layout.item_no_radius_photo, null);
                        final ImageView iv_advertise = (ImageView) view.findViewById(R.id.iv_advertise);
                        Glide.with(MoreNewGoodsActivity.this).load(listBaseDto.getData().get(i).getImgUrl()).into(iv_advertise);
                        views.add(view);
                    }
                    viewPager.addOnPageChangeListener(new ViewPagerIndicator(MoreNewGoodsActivity.this, viewPager, llIndcator, views.size()));
                    commonPagerAdapter = new CommonPagerAdapter(views, MoreNewGoodsActivity.this);
    ...
    private void getRecommendNewData() {
        viewModel.RecommendNews(pageNo, pageSize);
