...
public class MoreShopsAdapter extends RecyclerView.Adapter<MoreShopsAdapter.ViewHolder> {
    private Activity mContext;
    private List<StoreShowDto> datas;
    private CustomItemClickListener listener;

    public MoreShopsAdapter(Activity context, List<StoreShowDto> datas, CustomItemClickListener listener) {
        mContext = context;
        this.datas = datas;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_more_shops, parent, false);
