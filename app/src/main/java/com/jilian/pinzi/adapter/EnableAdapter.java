...
public class EnableAdapter extends RecyclerView.Adapter<EnableAdapter.ViewHolder> {
    ...
    public EnableAdapter(Activity context, List<SelectCardDto> datas, CustomItemClickListener listener,CheckListener checkListener) {
        mContext = context;
        this.datas = datas;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_enable_card, parent, false);
