...
public class CommentGoodAdapter extends RecyclerView.Adapter<CommentGoodAdapter.ViewHolder> {
    private Activity mContext;
    private List<ScoreBuyGoodsDto> datas;
    private CustomItemClickListener listener;
    private int classes;
    public CommentGoodAdapter(Activity context, List<ScoreBuyGoodsDto> datas, CustomItemClickListener listener,int classes) {
        mContext = context;
        this.datas = datas;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_commentgood, parent, false);
