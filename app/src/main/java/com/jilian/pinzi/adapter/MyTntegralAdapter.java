...
public class MyTntegralAdapter extends RecyclerView.Adapter<MyTntegralAdapter.ViewHolder> {
    private Activity mContext;
    private List<MyRecordDto> datas;
    private CustomItemClickListener listener;

    public MyTntegralAdapter(Activity context, List<MyRecordDto> datas, CustomItemClickListener listener) {
        mContext = context;
        this.datas = datas;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_mytntegral, parent, false);
