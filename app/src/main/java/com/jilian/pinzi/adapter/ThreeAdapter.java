...
public class ThreeAdapter extends RecyclerView.Adapter<ThreeAdapter.ViewHolder> {
    ...
    public interface ThreeListener{
        void onItemThreeClick(View view, int position);
    }
    public ThreeAdapter(Activity context, List<StoreShowDto> datas, ThreeListener listener) {
        mContext = context;
        this.datas = datas;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_three_good, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        Glide
                ...
                .into(holder.ivHead);
        holder.tvPoint.setText(NumberUtils.forMatOneNumber(datas.get(position).getGrade())+"分");
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(final View itemView, final ThreeListener listener) {
            super(itemView);
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    listener.onItemThreeClick(itemView, getAdapterPosition());
                }
            });
        }
