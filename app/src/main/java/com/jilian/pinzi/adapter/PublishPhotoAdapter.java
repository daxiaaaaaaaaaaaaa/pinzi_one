...
public class PublishPhotoAdapter extends RecyclerView.Adapter<PublishPhotoAdapter.ViewHolder> {
    ...
    public PublishPhotoAdapter(Activity context, List<String> datas, CustomItemClickListener listener, ClosePhotonListener closePhotonListener) {
        mContext = context;
        this.datas = datas;
    ...
    @Override
      public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.layout_publish_add, parent, false);
