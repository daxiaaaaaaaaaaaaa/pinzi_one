...
public class MoreNewGoodsAdapter extends RecyclerView.Adapter<MoreNewGoodsAdapter.ViewHolder> {
    private Activity mContext;
    private List<MainRecommendDto> datas;
    private CustomItemClickListener listener;
    private  int classes;
    public MoreNewGoodsAdapter(Activity context, List<MainRecommendDto> datas, CustomItemClickListener listener,int classes) {
        mContext = context;
        this.datas = datas;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_more_news_godd, parent, false);
