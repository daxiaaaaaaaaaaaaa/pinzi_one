...
public class MoreGoodsAdapter extends RecyclerView.Adapter<MoreGoodsAdapter.ViewHolder> {
    ...
    private int classes;
    public MoreGoodsAdapter(Activity context, List<MainRecommendDto> datas, CustomItemClickListener listener,int classes) {
        mContext = context;
        this.datas = datas;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_more_goods, parent, false);
