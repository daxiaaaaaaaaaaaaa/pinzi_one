...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.ViewHolder> {
    ...
    public interface SearchListener{
        void searchClick(int position);
    }

    public SearchAdapter(Activity context, List<HotWordListDto> datas, SearchListener listener) {
        mContext = context;
        this.datas = datas;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(final View itemView, final SearchListener listener) {
            super(itemView);
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    listener.searchClick( getAdapterPosition());
                }
            });
        }
